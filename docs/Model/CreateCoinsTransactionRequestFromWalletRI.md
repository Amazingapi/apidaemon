...
**recipients** | [**\com.cryptoapis.rest_apis.sdk\Model\CreateCoinsTransactionRequestFromWalletRIRecipientsInner[]**](CreateCoinsTransactionRequestFromWalletRIRecipientsInner.md) | Defines the destination of the transaction, whether it is incoming or outgoing. |
