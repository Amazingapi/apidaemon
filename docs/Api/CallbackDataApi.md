# com.cryptoapis.rest_apis.sdk\CallbackDataApi
...
```php
getAddressDetailsFromCallback($blockchain, $network, $address, $context): \com.cryptoapis.rest_apis.sdk\Model\GetAddressDetailsFromCallbackR
```
...
$apiInstance = new com.cryptoapis.rest_apis.sdk\Api\CallbackDataApi(
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetAddressDetailsFromCallbackR**](../Model/GetAddressDetailsFromCallbackR.md)
...
```php
getBlockDetailsByBlockHashFromCallback($blockchain, $network, $block_hash, $context): \com.cryptoapis.rest_apis.sdk\Model\GetBlockDetailsByBlockHashFromCallbackR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetBlockDetailsByBlockHashFromCallbackR**](../Model/GetBlockDetailsByBlockHashFromCallbackR.md)
...
```php
getBlockDetailsByBlockHeightFromCallback($blockchain, $network, $block_height, $context): \com.cryptoapis.rest_apis.sdk\Model\GetBlockDetailsByBlockHeightFromCallbackR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetBlockDetailsByBlockHeightFromCallbackR**](../Model/GetBlockDetailsByBlockHeightFromCallbackR.md)
...
```php
getTransactionDetailsByTransactionIDFromCallback($blockchain, $network, $transaction_id, $context): \com.cryptoapis.rest_apis.sdk\Model\GetTransactionDetailsByTransactionIDFromCallbackR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetTransactionDetailsByTransactionIDFromCallbackR**](../Model/GetTransactionDetailsByTransactionIDFromCallbackR.md)
