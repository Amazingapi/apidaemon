# com.cryptoapis.rest_apis.sdk\AutomaticTokensForwardingApi
...
```php
addTokensToExistingFromAddress($blockchain, $network, $context, $add_tokens_to_existing_from_address_rb): \com.cryptoapis.rest_apis.sdk\Model\AddTokensToExistingFromAddressR
```
...
$apiInstance = new com.cryptoapis.rest_apis.sdk\Api\AutomaticTokensForwardingApi(
...
$add_tokens_to_existing_from_address_rb = new \com.cryptoapis.rest_apis.sdk\Model\AddTokensToExistingFromAddressRB(); // \com.cryptoapis.rest_apis.sdk\Model\AddTokensToExistingFromAddressRB
...
| **add_tokens_to_existing_from_address_rb** | [**\com.cryptoapis.rest_apis.sdk\Model\AddTokensToExistingFromAddressRB**](../Model/AddTokensToExistingFromAddressRB.md)|  | [optional] |

### Return type

[**\com.cryptoapis.rest_apis.sdk\Model\AddTokensToExistingFromAddressR**](../Model/AddTokensToExistingFromAddressR.md)
...
```php
createAutomaticTokensForwarding($blockchain, $network, $context, $create_automatic_tokens_forwarding_rb): \com.cryptoapis.rest_apis.sdk\Model\CreateAutomaticTokensForwardingR
```
...
$network = testnet; // string | Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \"mainnet\" is the live network with actual data while networks like \"testnet\", \"ropsten\" are test networks.
$context = yourExampleString; // string | In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
$create_automatic_tokens_forwarding_rb = new \com.cryptoapis.rest_apis.sdk\Model\CreateAutomaticTokensForwardingRB(); // \com.cryptoapis.rest_apis.sdk\Model\CreateAutomaticTokensForwardingRB
...
| **network** | **string**| Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot; are test networks. | |
| **context** | **string**| In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. | [optional] |
| **create_automatic_tokens_forwarding_rb** | [**\com.cryptoapis.rest_apis.sdk\Model\CreateAutomaticTokensForwardingRB**](../Model/CreateAutomaticTokensForwardingRB.md)|  | [optional] |

### Return type

[**\com.cryptoapis.rest_apis.sdk\Model\CreateAutomaticTokensForwardingR**](../Model/CreateAutomaticTokensForwardingR.md)
...
```php
deleteAutomaticTokensForwarding($blockchain, $network, $reference_id, $context): \com.cryptoapis.rest_apis.sdk\Model\DeleteAutomaticTokensForwardingR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\DeleteAutomaticTokensForwardingR**](../Model/DeleteAutomaticTokensForwardingR.md)
...
```php
getFeeAddressDetails($blockchain, $network, $context): \com.cryptoapis.rest_apis.sdk\Model\GetFeeAddressDetailsR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetFeeAddressDetailsR**](../Model/GetFeeAddressDetailsR.md)
...
```php
listTokensForwardingAutomations($blockchain, $network, $context, $limit, $offset): \com.cryptoapis.rest_apis.sdk\Model\ListTokensForwardingAutomationsR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListTokensForwardingAutomationsR**](../Model/ListTokensForwardingAutomationsR.md)
