# com.cryptoapis.rest_apis.sdk\XRPRippleApi
...
```php
getLatestMinedXRPRippleBlock($network, $context): \com.cryptoapis.rest_apis.sdk\Model\GetLatestMinedXRPRippleBlockR
```
...
$apiInstance = new com.cryptoapis.rest_apis.sdk\Api\XRPRippleApi(
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetLatestMinedXRPRippleBlockR**](../Model/GetLatestMinedXRPRippleBlockR.md)
...
```php
getXRPRippleAddressDetails($network, $address, $context): \com.cryptoapis.rest_apis.sdk\Model\GetXRPRippleAddressDetailsR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetXRPRippleAddressDetailsR**](../Model/GetXRPRippleAddressDetailsR.md)
...
```php
getXRPRippleBlockDetailsByBlockHash($network, $block_hash, $context): \com.cryptoapis.rest_apis.sdk\Model\GetXRPRippleBlockDetailsByBlockHashR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetXRPRippleBlockDetailsByBlockHashR**](../Model/GetXRPRippleBlockDetailsByBlockHashR.md)
...
```php
getXRPRippleBlockDetailsByBlockHeight($network, $block_height, $context): \com.cryptoapis.rest_apis.sdk\Model\GetXRPRippleBlockDetailsByBlockHeightR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetXRPRippleBlockDetailsByBlockHeightR**](../Model/GetXRPRippleBlockDetailsByBlockHeightR.md)
...
```php
getXRPRippleTransactionDetailsByTransactionID($network, $transaction_hash, $context): \com.cryptoapis.rest_apis.sdk\Model\GetXRPRippleTransactionDetailsByTransactionIDR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetXRPRippleTransactionDetailsByTransactionIDR**](../Model/GetXRPRippleTransactionDetailsByTransactionIDR.md)
...
```php
listXRPRippleTransactionsByAddress($network, $address, $context, $limit, $offset, $transaction_type): \com.cryptoapis.rest_apis.sdk\Model\ListXRPRippleTransactionsByAddressR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListXRPRippleTransactionsByAddressR**](../Model/ListXRPRippleTransactionsByAddressR.md)
...
```php
listXRPRippleTransactionsByAddressAndTimeRange($network, $address, $from_timestamp, $to_timestamp, $context, $limit, $offset, $transaction_type): \com.cryptoapis.rest_apis.sdk\Model\ListXRPRippleTransactionsByAddressAndTimeRangeR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListXRPRippleTransactionsByAddressAndTimeRangeR**](../Model/ListXRPRippleTransactionsByAddressAndTimeRangeR.md)
...
```php
listXRPRippleTransactionsByBlockHash($network, $block_hash, $context, $limit, $offset): \com.cryptoapis.rest_apis.sdk\Model\ListXRPRippleTransactionsByBlockHashR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListXRPRippleTransactionsByBlockHashR**](../Model/ListXRPRippleTransactionsByBlockHashR.md)
...
```php
listXRPRippleTransactionsByBlockHeight($network, $block_height, $context, $limit, $offset): \com.cryptoapis.rest_apis.sdk\Model\ListXRPRippleTransactionsByBlockHeightR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListXRPRippleTransactionsByBlockHeightR**](../Model/ListXRPRippleTransactionsByBlockHeightR.md)
