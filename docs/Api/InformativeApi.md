# com.cryptoapis.rest_apis.sdk\InformativeApi
...
```php
getTransactionRequestDetails($transaction_request_id, $context): \com.cryptoapis.rest_apis.sdk\Model\GetTransactionRequestDetailsR
```
...
$apiInstance = new com.cryptoapis.rest_apis.sdk\Api\InformativeApi(
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetTransactionRequestDetailsR**](../Model/GetTransactionRequestDetailsR.md)
...
```php
getWalletAssetDetails($blockchain, $network, $wallet_id, $context): \com.cryptoapis.rest_apis.sdk\Model\GetWalletAssetDetailsR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetWalletAssetDetailsR**](../Model/GetWalletAssetDetailsR.md)
...
```php
getWalletTransactionDetailsByTransactionID($blockchain, $network, $transaction_id, $context): \com.cryptoapis.rest_apis.sdk\Model\GetWalletTransactionDetailsByTransactionIDR
```
...
$transaction_id = 3cba25201927d4c67d6f572822d6b57e9955ee3200f925943c50004b83820698; // string | Represents the unique identifier of a transaction, i.e. it could be `transactionId` in UTXO-based protocols like Bitcoin, and transaction `hash` in Ethereum blockchain.
$context = yourExampleString; // string | In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
...
[**\com.cryptoapis.rest_apis.sdk\Model\GetWalletTransactionDetailsByTransactionIDR**](../Model/GetWalletTransactionDetailsByTransactionIDR.md)
...
```php
listAllAssetsByWalletID($wallet_id, $context): \com.cryptoapis.rest_apis.sdk\Model\ListAllAssetsByWalletIDR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListAllAssetsByWalletIDR**](../Model/ListAllAssetsByWalletIDR.md)
...
```php
listAllAssetsFromAllWallets($context, $limit, $offset): \com.cryptoapis.rest_apis.sdk\Model\ListAllAssetsFromAllWalletsR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListAllAssetsFromAllWalletsR**](../Model/ListAllAssetsFromAllWalletsR.md)
...
```php
listDepositAddresses($blockchain, $network, $wallet_id, $context, $limit, $offset): \com.cryptoapis.rest_apis.sdk\Model\ListDepositAddressesR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListDepositAddressesR**](../Model/ListDepositAddressesR.md)
...
```php
listSupportedTokens($blockchain, $network, $context, $limit, $offset): \com.cryptoapis.rest_apis.sdk\Model\ListSupportedTokensR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListSupportedTokensR**](../Model/ListSupportedTokensR.md)
...
```php
listWalletTransactions($blockchain, $network, $wallet_id, $context, $limit, $offset): \com.cryptoapis.rest_apis.sdk\Model\ListWalletTransactionsR
```
...
[**\com.cryptoapis.rest_apis.sdk\Model\ListWalletTransactionsR**](../Model/ListWalletTransactionsR.md)
