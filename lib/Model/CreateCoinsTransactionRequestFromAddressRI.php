...
class CreateCoinsTransactionRequestFromAddressRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fee_priority' => 'string',
        'note' => 'string',
        'recipients' => '\com.cryptoapis.rest_apis.sdk\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[]',
    ...
    */
     ...
     * Gets recipients
     *
     * @return \com.cryptoapis.rest_apis.sdk\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[]
     */
     ...
     * Sets recipients
     *
     * @param \com.cryptoapis.rest_apis.sdk\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[] $recipients Defines the destination for the transaction, i.e. the recipient(s).
     *
     * @return self
     */
