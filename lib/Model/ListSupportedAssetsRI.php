...
class ListSupportedAssetsRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('original_symbol', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($original_symbol)) {
            throw new \InvalidArgumentException('non-nullable original_symbol cannot be null');
        }
