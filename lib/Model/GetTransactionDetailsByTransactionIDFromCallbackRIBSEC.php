...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSEC implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'contract' => 'string',
        'gas_limit' => 'string',
        'gas_price' => '\com.cryptoapis.rest_apis.sdk\Model\GetTransactionDetailsByTransactionIDRIBSECGasPrice',
        'gas_used' => 'string',
        'input_data' => 'string',
        'nonce' => 'int'
    ];
    ...
    */
     ...
     * Gets gas_price
     *
     * @return \com.cryptoapis.rest_apis.sdk\Model\GetTransactionDetailsByTransactionIDRIBSECGasPrice
     */
     ...
     * Sets gas_price
     *
     * @param \com.cryptoapis.rest_apis.sdk\Model\GetTransactionDetailsByTransactionIDRIBSECGasPrice $gas_price gas_price
     *
     * @return self
     */
