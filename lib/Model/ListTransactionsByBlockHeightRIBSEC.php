...
class ListTransactionsByBlockHeightRIBSEC implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'contract' => 'string',
        'gas_limit' => 'string',
        'gas_price' => '\com.cryptoapis.rest_apis.sdk\Model\ListTransactionsByBlockHeightRIBSECGasPrice',
        'gas_used' => 'string',
        'input_data' => 'string',
        'nonce' => 'string'
    ];
    ...
    */
     ...
     * Gets gas_price
     *
     * @return \com.cryptoapis.rest_apis.sdk\Model\ListTransactionsByBlockHeightRIBSECGasPrice
     */
     ...
     * Sets gas_price
     *
     * @param \com.cryptoapis.rest_apis.sdk\Model\ListTransactionsByBlockHeightRIBSECGasPrice $gas_price gas_price
     *
     * @return self
     */
