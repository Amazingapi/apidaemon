...
class GetFeeRecommendationsRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fast', $data ?? [], null);
        $this->setIfExists('slow', $data ?? [], null);
        $this->setIfExists('standard', $data ?? [], null);
        $this->setIfExists('fee_cushion_multiplier', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($fast)) {
            throw new \InvalidArgumentException('non-nullable fast cannot be null');
        }
    ...
    {
        if (is_null($slow)) {
            throw new \InvalidArgumentException('non-nullable slow cannot be null');
        }
     ...
     *
     * @param string $fee_cushion_multiplier Fee cushion multiplier used to multiply the base fee
     *
     * @return self
     */
    public function setFeeCushionMultiplier($fee_cushion_multiplier)
    {
        if (is_null($fee_cushion_multiplier)) {
            throw new \InvalidArgumentException('non-nullable fee_cushion_multiplier cannot be null');
        }
