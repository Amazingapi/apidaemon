...
class GetRawTransactionDataRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('transaction_hex', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($transaction_hex)) {
            throw new \InvalidArgumentException('non-nullable transaction_hex cannot be null');
        }
