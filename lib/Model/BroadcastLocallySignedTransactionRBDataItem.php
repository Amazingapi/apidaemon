...
class BroadcastLocallySignedTransactionRBDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('signed_transaction_hex', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($signed_transaction_hex)) {
            throw new \InvalidArgumentException('non-nullable signed_transaction_hex cannot be null');
        }
