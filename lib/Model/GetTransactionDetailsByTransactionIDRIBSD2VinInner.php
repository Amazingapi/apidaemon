...
class GetTransactionDetailsByTransactionIDRIBSD2VinInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'addresses' => 'string[]',
        'coinbase' => 'string',
        'script_sig' => '\com.cryptoapis.rest_apis.sdk\Model\GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig',
        'sequence' => 'int',
        'txid' => 'string',
        'txinwitness' => 'string[]',
        'value' => 'string',
    ...
    */
     ...
     * Gets script_sig
     *
     * @return \com.cryptoapis.rest_apis.sdk\Model\GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig
     */
     ...
     * Sets script_sig
     *
     * @param \com.cryptoapis.rest_apis.sdk\Model\GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig $script_sig script_sig
     *
     * @return self
     */
