...
class GetBlockchainEventSubscriptionDetailsByReferenceIDRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('deactivation_reasons', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \com.cryptoapis.rest_apis.sdk\Model\ListBlockchainEventsSubscriptionsRIDeactivationReasonsInner[]|null
     */
     ...
     *
     * @param \com.cryptoapis.rest_apis.sdk\Model\ListBlockchainEventsSubscriptionsRIDeactivationReasonsInner[]|null $deactivation_reasons Represents the deactivation reason details, available when a blockchain event subscription has status isActive - false.
     *
     * @return self
     */
    public function setDeactivationReasons($deactivation_reasons)
    {
        if (is_null($deactivation_reasons)) {
            throw new \InvalidArgumentException('non-nullable deactivation_reasons cannot be null');
        }
