...
/**
 * PrepareANonFungibleTokenTransferFromAddressRI Class Doc Comment
 *
 * @category Class
 * @package  com.cryptoapis.rest_apis.sdk
 * @author   OpenAPI Generator team
 ...
 */
class PrepareANonFungibleTokenTransferFromAddressRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepareANonFungibleTokenTransferFromAddressRI';
    ...
    protected static $openAPITypes = [
        ...
        'sender' => 'string',
        'token_id' => 'string',
        'blockchain_specific' => '\com.cryptoapis.rest_apis.sdk\Model\PrepareANonFungibleTokenTransferFromAddressRIBS'
    ];
    ...
    */
     ...
     * Sets recipient
     *
     * @param string $recipient Represents the address which sends this transaction. In UTXO-based protocols like Bitcoin there could be several senders while in account-based protocols like Ethereum there is always only one sender.
     *
     * @return self
     */
     ...
     * Sets sender
     *
     * @param string $sender The address which receives this transaction. In UTXO-based protocols like Bitcoin there could be several senders while in account-based protocols like Ethereum there is always only one recipient.
     *
     * @return self
     */
     ...
     *
     * @return \com.cryptoapis.rest_apis.sdk\Model\PrepareANonFungibleTokenTransferFromAddressRIBS
     */
     ...
     *
     * @param \com.cryptoapis.rest_apis.sdk\Model\PrepareANonFungibleTokenTransferFromAddressRIBS $blockchain_specific blockchain_specific
     *
     * @return self
     */
