...
class AddressTokensTransactionConfirmedToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'created_by_transaction_id' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('created_by_transaction_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($created_by_transaction_id)) {
            throw new \InvalidArgumentException('non-nullable created_by_transaction_id cannot be null');
        }
