...
class DecodeRawTransactionHexRIS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'max_fee_priority_per_gas' => false,
        'nonce' => false,
        'r' => false,
        'recipient' => false,
        's' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('max_fee_priority_per_gas', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($max_fee_priority_per_gas)) {
            throw new \InvalidArgumentException('non-nullable max_fee_priority_per_gas cannot be null');
        }
