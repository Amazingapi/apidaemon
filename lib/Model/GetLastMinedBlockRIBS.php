...
class GetLastMinedBlockRIBS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets difficulty
     *
     * @param string|null $difficulty Numeric representation of the block difficulty
     *
     * @return self
     */
     ...
     *
     * @param int $operations_count Representation of the blocks' transaction operations count.
     *
     * @return self
     */
