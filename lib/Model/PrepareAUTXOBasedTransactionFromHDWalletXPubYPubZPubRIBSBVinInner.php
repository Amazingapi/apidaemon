...
/**
 * PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner Class Doc Comment
 *
 * @category Class
 * @package  com.cryptoapis.rest_apis.sdk
 * @author   OpenAPI Generator team
 ...
 */
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepareAUTXO_BasedTransactionFromHDWalletXPubYPubZPubRIBSB_vin_inner';
    ...
    */
     ...
     *
     * @param int $derivation_index Representation of the derivation index of the xpub
     *
     * @return self
     */
