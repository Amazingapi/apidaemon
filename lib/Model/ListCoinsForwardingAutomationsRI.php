...
class ListCoinsForwardingAutomationsRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'callback_url' => false,
        'confirmations_count_trigger' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('confirmations_count_trigger', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($confirmations_count_trigger)) {
            throw new \InvalidArgumentException('non-nullable confirmations_count_trigger cannot be null');
        }
