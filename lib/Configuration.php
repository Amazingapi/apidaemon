...
namespace com.cryptoapis.rest_apis.sdk;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (com.cryptoapis.rest_apis.sdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2023-04-25' . PHP_EOL;
